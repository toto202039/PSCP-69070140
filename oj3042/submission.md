...
```text
รับinputมา เป็นเลขตัวนึง จานั้นเราเอามาลบหลักหน่วยออกเปลี่ยนเป็น0และลบทีละ10มาเรื่อยๆจนเหลือ0
```
...
```text
รับinputมาเป็นint จากนั้นผมจะนําไปลบกับหลักสุดท้ายของตัวมันเองและเอามาเข้าwhile loopครับ ว่า ถ้ายังมากกว่ากว่า0ให้ทําต่อไปเรื่อยๆ ลบ10ไปเรื่อยๆจนหยุดที่0
```
...
```text
รับinputมาเป็นint จากนั้นผมจะนําไปลบกับหลักสุดท้ายของตัวมันเองและเอามาเข้าwhile loopครับ ว่า ถ้ายังมากกว่ากว่า0ให้ทําต่อไปเรื่อยๆ ลบ10ไปเรื่อยๆจนหยุดที่0 แบบวิธีแรก
```
...
```text
ทดสอบกรณีทั่วไปที่ N ไม่ได้หารด้วย 10 ลงตัว ตัวเลขเริ่มจาก N (35) วนลงไปหา 0 โดยดึงเฉพาะเลขที่หารด้วย 10 ลงตัวตามลำดับจากมากไปน้อย
```
...
```text
เพื่อดูว่าจะได้0ตามที่ต้องการไหม
```
