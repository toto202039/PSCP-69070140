...
```text
รับinput 1 ตัวเป็นราคาตั้งต้นและนําไปคํานวน เพื่อให้ได้ราคาใหม่
```
...
```text
ผมรับinput เป็นจํานวนเต็มมา1ตัว
และตั้งตัวแปรใหม่มา2ตัวเพื่อให้ง่ายต่อการคํานวนคือ
fee คือค่าบริการ โดยเป็น10%จากราคาอาหาร ซึ่งเราจะนํา inputตัวแรก ไปคูณ10และหาร100เพื่อเอา10%
และvatคือภาษี7%คิดจากราคาทั้งหมดรวมค่า บริการ เราจึงเอาfeeไปบวกกับinputแรก และ คูณด้วย7 หาร100 เพื่อที่จะทราบ7%ของทั้งหมด
ทีนี้เราก็ตั้งเงื่อไขแรกครับคือขั้นตํ่าของค่าบริการคือ50บาท เราจึงตั้งเงื่อนไขว่า ถ้า feeคิดออกมาได้น้อยกว่า50บาท
ให้outputออกมาเป็นราคาต้น+50 และเอา ราคาต้น+50คูณ7หาร100เพื่อบวกราคาภาษี
กรณีสองคือเมื่อfeeเกิน1000บาทซึ่งเกินmaxที่ตั้งไวตามโจทย์
เราก็จะทําแบบเงื่อนไขแรกแต่เปลี่ยนจาก50เป็น1000
สุดท้ายเงื่อนไขปกตืคือถ้าfeeมากกว่า50 เราจะนําinputราคาแรกไปบวกกับfeeและvatเพื่อให้ได้ผลลัพธ์ออกมา
...
```text
เหมือนวิธีแรกครับเพราะผ่านตั้งแต่แนวคิดแรก
ผมรับinput เป็นจํานวนเต็มมา1ตัว
และตั้งตัวแปรใหม่มา2ตัวเพื่อให้ง่ายต่อการคํานวนคือ
fee คือค่าบริการ โดยเป็น10%จากราคาอาหาร ซึ่งเราจะนํา inputตัวแรก ไปคูณ10และหาร100เพื่อเอา10%
และvatคือภาษี7%คิดจากราคาทั้งหมดรวมค่า บริการ เราจึงเอาfeeไปบวกกับinputแรก และ คูณด้วย7 หาร100 เพื่อที่จะทราบ7%ของทั้งหมด
...
```text
เพื่อดูว่าค่าบริการขั้นตํ่าทํางานตรงไหม
```
...
```text
เพื่อดูว่าค่าบริการ1000บาทจะไม่เกินนี้จริงๆ
```
...
```text
เพื่อดูว่าเงื่อนไขในกรณีปกติที่ค่าบริการเกิน50แต่ไม่ถึง1000ทํางานได้ถูกต้องไหม
```
