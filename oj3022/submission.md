...
```text
รับinput3ตัว เป็นอุณหภูมิตั้งต้น หน่วยของอุณหภูมิตั้งต้น และหน่วยใหม่ที่จะแปลง
จากนั้นนําไปคํานวนทางคณิตศาสตร์และoutputออกมาเป็นอุณหภูมิใหม่
...
```text
ตั้งใจว่าจะรับinput3ตัวแบบที่กล่าวไปครับ ทีนี้ก็จะตั้งเงื่อนไขไปเรื่อยๆ 
เช่นถ้าอุณหภูมิแรก=C และอุณหภูมิใหม่=F ให้เข้าเงื่อนไขและทําการคํานวนทางคณิตศาสตร์เพื่อแปลงหน่วยและprintออกมาครับ
```
...
```text
ทดสอบการเปลี่ยนFไปเป็นCว่าได้ผลไหม
```
...
```text
ทดสอบว่าถ้าเป็นอุณหภูมิในหน่วยแบบtestcase1แต่สลับตํษแหน่งกันรจะยังใช้ได้ไหม
```
...
```text
เพื่อทดสอบว่าอุณภูมิเดิมแปลงเป็นอุณหภูมิเดิมควรได้เท่าเดิมหรือไม่
```
