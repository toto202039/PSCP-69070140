...
```text
หาว่าในช่วงจำนวนเต็มตั้งแต่ A ถึง B มีจำนวนกี่ตัวที่เมื่อนำไปหารด้วย C แล้วเหลือเศษเท่ากับ D
```
...
```text
ผมจะเขียนเป็นสมการทางคณิตศาสตร์คือ ต้องการหาจำนวนของ x ที่อยู่ในช่วง A  < x < B ซึ่งอยู่ในเงื่อนไขในการคํานวนที่คิดไว้คือ a % c == d คีบ เร่จะทราบ d ทันที
```
...
```text
ช่วงแคบๆ และไม่มีตัวเลขที่เข้าเงื่อนไข
```
...
```text
กรณีที่ A มากกว่าหรือเท่ากับ B
```
