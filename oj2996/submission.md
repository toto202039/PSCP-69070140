...
```text
รับinputมา1ค่า และแปลงให้ตัวอักให้ตัวอักษรกลับหลัง และจากนั้นเราก็printออกมา
```
...
```text
น่าจะรับเป็นstr แล้วก็ใช้string slicing ในการย้อนตัวอักษรครับ
```
...
```text
รับinputเข้ามา1ตัว เป็นอะไรก็ได้
จากนั้นสร้างตัวแปรใหม่ชื่อreverseและใช้string slicing [::-1]เป็นการย้อนกลับตัวอักษร
และสั่งprintตัวแปรใหม่มา
```
...
```text
เป็นการทดสอบเบื้องต้นว่าโปรแกรมทํางานได้ตามที่ต้องการเบื้องต้นไหม
```
...
```text
เริ่มใช้ตัวพิมพ์ใหญ่และเลขเข้ามา เพื่อจะดูว่ายังสามารถrunได้ถูกต้องไหม
```
...
```text
เพิ่มการเว้นวรรคเข้ามาเพื่อจะดูว่าโปรแกรมยังทํษงานได้ถูกต้องหรือไม่
```
