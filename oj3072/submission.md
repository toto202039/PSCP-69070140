...
```text
รับinputเป็นคํามาแล้วรับจํานวนสระครับ
```
...
```text
ผมจะรับinputมาแล้วส่งขึ้นไปในlistตั้งเงื่อไขให้มันนับตัวอักษรด้วยฟังชั่น countเพื่อนนับแต่ละตัวและprintออกมาครับ
```
