...
```text
รับinput มาคํานวนจํานวนอิฐก้อนเล็กที่มากที่สุดที่เราจะใช้
```
...
```text
รับ input มา สองตัวครับ และนําไปคํนวนโดนนําอิฐก้อนใหญ่ไปลบกับจํานวนที่ต้องการคูณด้วย5 เพื่อเราจะหาว่า จํานวนที่มากที่สุดของอิฐก้อนใหญ่เท่าไหร่ ทีนี้เราก็จะนําไปลบกับอิฐก้อนเล็กคครับ เราจะทราบทันที
```
...
```text
รับ input มา สองตัวครับ และนําไปคํนวนโดนนําอิฐก้อนใหญ่ไปลบกับจํานวนที่ต้องการคูณด้วย5 เพื่อเราจะหาว่า จํานวนที่มากที่สุดของอิฐก้อนใหญ่เท่าไหร่ ทีนี้เราก็จะนําไปลบกับอิฐก้อนเล็กคครับ เราจะทราบทันที ตามวิธีแรกครับ
```
...
```text
สมมติว่าพอดีเป๊ะด้วยอิฐใหญ่ ใช้แค่อิฐใหญ่ก็พอ ไม่ต้องใช้อิฐเล็ก
```
...
```text
ต้องใช้อิฐทั้งใหญ่และเล็กผสมกัน
```
...
```text
ถ้าเรามีอิฐใหญ่มีเหลือเฟือ แต่จำกัดด้วยจำนวน b
```
