...
```text
รับinputรางวัลมาและinputตัวที่สองคือ สลากที่เราซื้อครับ จากนั้นนํามาคํานวนตามโจทย์ว่าแต่ละตัวถ้าตรงกันจได้รางวัลสุดท้ายเท่าไหร่
```
...
```text
รับintputมา2ตัวที่แยกด้วยsplitครับ ทีนี้ผมจะทําไปเก็บไว้ในlistเพื่อให้ง่ายต่อการคํานวน โดยผมตั้งตัวแปรคือmatching เป็น 0 ไปก่อน แล้วทีนี้เราก็จะเช็คแค่2ตัวท้ายเป็นหลักครับ ถ้าตรงเราก็เอาไปบวกในmatching += 1 แล้วพอรเาได้ค่าmatchingมา ผมก็จะเริ่มเอาไปเทียบว่าแมชกันกี่ตัวและตัวอักษรตรงไหม
```
...
```text
เหมือนแผนแรกครับรับintputมา2ตัวที่แยกด้วยsplitครับ ทีนี้ผมจะทําไปเก็บไว้ในlistเพื่อให้ง่ายต่อการคํานวน โดยผมตั้งตัวแปรคือmatching เป็น 0 ไปก่อน แล้วทีนี้เราก็จะเช็คแค่2ตัวท้ายเป็นหลักครับ ถ้าตรงเราก็เอาไปบวกในmatching += 1 แล้วพอรเาได้ค่าmatchingมา ผมก็จะเริ่มเอาไปเทียบว่าแมชกันกี่ตัวและตัวอักษรตรงไหม
```
...
```text
เช็คว่าถ้าไม่มีเลขตรงเลยตรงแค่อักษรจะถูกไหม
```
