...
```text
เรารับinputมาตามจํานวนนึงแล้วเราก็เอาใส่กรอบคับ
```
...
```text
เราจะลูปครับ5ครั้งเพื่อนําข้อความไปใส่ในlistทีนี้ผมก็จะเอามาloopอีกรอบโดยใช้    print(f"* {i}{' ' * (len(longest_word) - len(i))} *")
 เพื่อสร้างกรอบรูปนั่นเอง โดยตัวเว้นวรรคจะทํางานพอดีโดยช่องว่างที่เหลือจะมากที่าสุดตามจํานวนที่มากที่สุด
```
...
```text
ตามวิธีแรกครับเราจะลูปครับ5ครั้งเพื่อนําข้อความไปใส่ในlistทีนี้ผมก็จะเอามาloopอีกรอบโดยใช้    print(f"* {i}{' ' * (len(longest_word) - len(i))} *")
 เพื่อสร้างกรอบรูปนั่นเอง โดยตัวเว้นวรรคจะทํางานพอดีโดยช่องว่างที่เหลือจะมากที่าสุดตามจํานวนที่มากที่สุด
```
...
```text
ข้อความยาวไม่เท่ากันและมีช่องว่าง
```
