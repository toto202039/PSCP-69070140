...
```text
รับinput9ตัวแรกมาเป็นอัตราการขยายตัวต่อ1วินาทีว่าจะขยายตัวไปกี่ตารางหน่วยเป็นวงกลม และ ใสนบรรทัดเดียวกันเว้นวรรค ก็จะเป็นจํานวนที่เราจะรับinputเข้ามา จากนั้นเราก็ใส่inputพิกัดตามจําวนครั้งที่เรากําหรนด และนํ้าไปคํานวนทาคณิตศาสตร์
...
```text
ผมตั้งใจจะทําlistเพื่อเก็ข้อมูลทีละชุดครับเพราะถนัดแบนนี้
ตอนแรกผมก็ใช้split เพื่อแนยกinputแรกเป็นสองค่า คือ Sที่เป็นอัตราการขยายตัว และ จํานวนinput พิกัดที่เราต้องการ
ทีนี้ผมก็จะใช้foor loopรับinputมาครับ และให้วนกลับเข้าไปappendในlist
และผมก็ใช้for loopที่สอง เพื่อจับทุกๆsetในlistมาแยกเป็นx y และคํานวนทุกตัวครับ
โดยเราจะหารัศมีเป้าหมายที่หมึกจะแพร่ขยายไปก่อน
พอเราทราบแล้วเราก็จะใช้สูตรหาเวลาที่จะขยายไปถึงจุดนั้นครับคือ pi คูณRกําลังสองหารS
จากนั้นก็สั่งprintออกมา
```
...
```text
เช่นเดียวกับแผนแรกเลยครับเพราะสําเร็จทันที
ผมตั้งใจจะทําlistเพื่อเก็ข้อมูลทีละชุดครับเพราะถนัดแบนนี้
ตอนแรกผมก็ใช้split เพื่อแนยกinputแรกเป็นสองค่า คือ Sที่เป็นอัตราการขยายตัว และ จํานวนinput พิกัดที่เราต้องการ
ทีนี้ผมก็จะใช้foor loopรับinputมาครับ และให้วนกลับเข้าไปappendในlist
และผมก็ใช้for loopที่สอง เพื่อจับทุกๆsetในlistมาแยกเป็นx y และคํานวนทุกตัวครับ
...
```text
กรณีพิกัดรับค่าติดลบ และค่าความเร็วเป็นทศนิยม ไม่ควรออกมาเป็นผลลัพธ์เพราะเรารับเป็นint
```
...
```text
กรณีทั่วไปเช็คว่าทํางานได้ปกติไหม
```
