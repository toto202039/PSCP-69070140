...
```text
รับinputมาสองตัวเพื่อดูว่าคะแนนสูงสุดห่างจากคะแนนตํ่าสุดมากกว่า2ไหม ถ้ามากกว่าให้เราoutputเป็นsurprising
```
...
```text
ตั้งใจจะเอาคะแนนมากสุดไปลบกับคะแนนรวมก่อนครับ พอได้คะแนนรวม ที่เหลือถ้ายังมากกว่า10ก็ให้เอาไปลบ10 แต่ถ้าน้อยกว่า10ก็ให้return 1 ซึ่งlogicนี้ผิดแบบมากๆๆๆ เพราะผมเข้าใจคะแนนตํ่าสุดผิดมากๆ
```
...
```text
ผมเอาคะแนนทั้งหมดไปลบกัยคะแนนมากที่สุดคูณด้วยสอง ซึ่งสมการนี้ตั้งขึ้นโดยเราอนุมานให้คะแนนมากที่สุดเท่ากันสองคน พอลบกันมันจะได้คะแนนตํ่าสุดแน่นอนครับ
และก็เอาไปเข้าเงื่อนไขif else
```
...
```text
ทดสอบเบื้องต้นว่าsurprisingทํางานตามเงื่อนไขไหม
```
...
```text
เพื่อดูว่าnot surprisingทํางานถูกต้องในเบื้องต้นไหม
```
...
```text
ถ้าคะแนนทุกคนเท่ากันผลจะออกมาเป็นnot surprisingไหม
```
...
```text
สิทธวีร์ น้าวิไลเจริญ section3
```

เขาช่วยอะไร

```text
อธิบายเรื่องคะแนนตํ่าสุด
```

คุณยังทำอะไรด้วยตนเอง

```text
เอาไปประยุคและคิดสมการต่อเอง
```
