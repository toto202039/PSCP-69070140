...
```text
คือเราเราตัวอักษรหรือตัวเลขมาครับ ทีนี้เราจะแปลงเป็ชื่อไพ่เต็มๆ เช่น qก็คือqueen dก็คือdiamond เราก็จะแปลงเป็นqueen of diamond
```
...
```text
ผมจะรับinputมาครับแล้วทีนี้ก็แยกตัวแรกกับตัวที่สองด้วยsplit  ทีนี้ผมก็จะเอามาคํานวนด้วยif elif ครับ ว่าถ้าindexตัวที่1ตรงกับอันนี้และindexตัวที่สองตรงกับแบบนี้ ผมจะprintfออกมาครับ แบบนี้ครับ
 print(f"{card} of spades") แล้วก็ทําไปเรื่อยๆครับ
```
...
```text
แนวคิกดเดียวกับวิธีแรกครับแต่ผมเพิ่มกรณีขอบเลข10มา เพราะมันจะทําให้indexมีสามตัว ผมเลยจะเขียนว่าถ้าหลักที่2 isdigit ก็ให้ทําเงื่อนไขแบบนี้ print(f"{card} of spades")
```
...
```text
ช็คการประมวลผลไพ่เลข 10 ความยาวสตริง 3 ตัวอักษร
```
...
```text
เช็คการแปลงตัวอักษรพิมพ์เล็กเป็นพิมพ์ใหญ่
```
