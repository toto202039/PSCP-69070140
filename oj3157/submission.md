...
```text
รับค่าควที่มาก่อน แล้วทีนี้ก็รับค่าบวกลบมาหลายๆตัวเพื่อมาคํานวนตามจํานวนเลขที่รับมาตอนแรก
```
...
```text
ผมก็จะสร้างloopเพื่อเช็คinputทุกตัวครับ ถ้าเป็น + ก็ บวกเพอิ่มตัวแปลไป1 และ - ก็บวกใส่ตัวแปรไป1 ทีนี้ก็เอามาคํานวนสุดท้ายครัยตามค่า +คือ10 - คิอ 5 เราก็จับค่าแรกมาคูณกระจายและลบกัน
```
