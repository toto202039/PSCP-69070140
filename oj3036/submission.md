...
```text
รับตัวเลขมา1ตัว เป็นตัวเลขที่ไม่ทราบว่าอยู่ชั้นไหนของพีระมิดแต่เราจะเอามาหาค่าที่ใช้น้อยที่สุดในการพังประตู
```
...
```text
ผมพยายามสังเกตุพฤติกรรมของตัวเลขและทราบว่า
แถวที่เป็นเลขคู่ เลขคี่จะสั้นกว่า1
แถวที่เป็นเลขคี่ เลขคู่จะสั้นกว่า1

ตัวหน้าสุดเท่ากับตัวมันเองบวกทุกตัวในแถว และตัวสุดท้ายจะห่า


ตัวแรกของแถวจะห่างจากตัวถัดไปโดยstack + 2 ไปเรื่อยๆ 2 + 3 เป็น 5 , 5 + 5(มาจาก 3+2)เป็น10 ,10  + 7 = 17 7มาจาก (5+ 2)
และตัวสุดท้ายก็ทํางานเหมือกัน stack 2เรื่อยๆ
เม


จํานวนจะขึ้นแถวใหม่ก็ต่อเมื่อ
และจากนั้นก็ทราบว่าแต่ละแถวทุกตัวจะสามรถนํษมาsquareroot และปัดเศษขึ้น มันจะอยู่ในแถวนั้นพอดิบพอดีอย่างน่าเหลือเชื่อ ผมเลยใช้ประโยชน์ตรงจุดนี้ในการคํานวน
```
...
```text
เพราะ1ไม่ต้องพังประตูใดๆทั้งนั้น
```
...
```text
ทดสอบว่า3ควรจะพังแค่1ประตูตามภาพจริงไหม
```
...
```text
เพื่อดูว่าสมมติฐานที่เราตั้งมาถูกต้องหรือไม่ว่า
แถวที่เป็นเลขคู่ เลขคี่จะสั้นกว่า1
แถวที่เป็นเลขคี่ เลขคู่จะสั้นกว่า1
