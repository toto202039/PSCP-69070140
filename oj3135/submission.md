...
```text
อารมคล้ายการเล่นส่งของรอบวงกลมครับ คือถ้ามันloopไปจนถึงคนแรกมันก็จะหยุด เพราะมันจะไม่มีวันไปหาคนอื่นแล้วนอกจากนั้น หรือถ้าหยุดที่โขมยก็หายไปเลย
...
```text
รับinputมาครับ ทีนี้เราจะloopครับ ถ้าค่าปัจจุบัน+kยังไม่เท่ากับโจรก็ยังloopต่้อไปและนับเพิ่ม พอถึงโจรเราก็จะbreakครับ
```
...
```text
ตามแผนแรกเลยครับ
รับinputมาครับ ทีนี้เราจะloopครับ ถ้าค่าปัจจุบัน+kยังไม่เท่ากับโจรก็ยังloopต่้อไปและนับเพิ่ม พอถึงโจรเราก็จะbreakครับ ซึ่งผมจะใช้listเป็นตัวนับครับ แล้วก็print len ออกมา
...
```text
กรณีขโมยเป็นคนเบอร์ 1 ตั้งแต่เริ่ม
```
...
```text
กรณีขโมยอยู่นอกเส้นทางส่งของ วนกลับมาคนเดิม
```
