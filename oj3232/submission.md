...
```text
รับเลขมาสองตัวครัย ทีนี้เอาไปloopดูว่า เลขตัวเลขจะไปถึงเลขตัวที่2ได้ไหมหากลดไปทีละ2
```
...
```text
รับเลขมาสองตัวครับ แล้วผมก็จะตั้ตัวแปร3ตัวคือ ระยะทาวตอนนี้ จํานวนครั้วที่กระโดด และ ระยะทางทั้หมดแล้วเอาไปloopโดยใช้while ซึ่งจะให้ว่า ถ้าcurrentมันยังน้อยกว่าเป้าหมายของบเราก็ทํางานต่อไป โดย count +1 เพราะหมายถึงการกระโดด1ครั้งแล้ว แล้วก็total distance ก็บวก = การกระโดด1ครั้ง และก็สุดท้าย current -= 2ครับ เราก็จะได้วิธีคํารนวน
```
...
```text
ถึงเป้าหมายตั้งแต่การกระโดดครั้งแรก
```
...
```text
ต้องกระโดดหลายครั้งโดยพลังลดลงเรื่อยๆ แต่สำเร็จ
```
