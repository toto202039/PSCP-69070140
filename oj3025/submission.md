...
```text
เรารับinput2ตัวเป็นเดือนละวัน และเอาไปเทียบว่าช่วงเวลานี้อยู่ในฤดูไหนตามโจทย์ และoutputออกมา
```
...
```text
ผมตั้งใจจะเริ่มจากฤดูที่เดือนเยอะที่สุดก่อนคือfall
โดยการคิดของผมคือจะตั้งเงื่อนไขสองตัวคือ ถ้าเดือนมากกว่าx และ วันที่มากกว่า y จะprintฤดูนั้นออกมา
```
...
```text
แผนแรกถือว่ามาถูกทาง
โดยการคิดของผมคือจะตั้งเงื่อนไขสองตัวคือ ถ้าเดือนมากกว่าx และ วันที่มากกว่า y จะprintฤดูนั้นออกมา
แต่เราควรจะเริ่มด้วยwinterเพราะช่วงเดือน12ก็นับเป็นwinterเช่นกัน
```
...
```text
เพื่อเช็คว่าเงื่อนไขแรกทํางานเป็นwinterจริงไหม
```
...
```text
ถ้าเป็นเดือน12แต่ยังไม่ถึงวันที่จะเป็นwinterควรจะเป็นfallไหม
```
...
```text
วันที่ 5 จะไม่ถึง 21 แต่ในเงื่อนไข elif month >= 9 and day >= 21 or month > 9 มีท่อนหลังคือ or month > 9 ซึ่ง 11 > 9 เป็นจริง ทำให้เช็กผ่านและพิมพ์ fall ออกมาได้ถูกต้อง
```
