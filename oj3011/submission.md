...
```text
รับinputมาสองตัว
เอาไปคํานวนในเงื่อนไขif elif
และprintเป็นoutputใหม่1ตัว
...
```text
รับstring inputสีมาสองค่าด้วยสองตัวแปร
จากนั้นนําไปตั้งเงื่อนไขว่าถ้าinputตรงกันให้printสีที่เราต้องการออกมา
เช่น ถ้าinputเป็น RED และ BLUE
ให้print VIOLET
```
...
```text
คล้ายกับวิธีแรกแต่ปรับเปลี่ยนนิดหน่อยเนื่องจาก
วิธีแรก
รับstring inputสีมาสองค่าด้วยสองตัวแปร
จากนั้นนําไปตั้งเงื่อนไขว่าถ้าinputตรงกันให้printสีที่เราต้องการออกมา
เช่น ถ้าinputเป็น RED และ BLUE
...
เรายังขาดedgecaseบางตัวคือ ถ้าinputเป็นสีเดียวกันและถ้าสมมติinputเป็นBLUE และ RED สลับกัน โปรแกรมจะไม่ทํางาน ผมจึงเพิ่มเงื่อนไขบางตัวลงไป
...
```text
เป็นbasicว่าโปรแกรมทํางานได้ไหม
```
...
```text
ลองสลับสีแรกกับสีที่สองดูว่าจะยังได้ผลลัพธ์แบบเดิมไหม
```
...
```text
ลองให้inputเป็นสีเดียวกันดู เพื่อดูว่าจะได้ผลตรงตามที่คาดหวังไหม
```
